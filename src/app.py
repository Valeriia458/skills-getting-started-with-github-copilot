...
activities = {
    ...
    "Soccer Club": {
        "description": "Practice team play and compete in friendly soccer matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["jacob@mergington.edu", "ava@mergington.edu"]
    },
    "Swim Team": {
        "description": "Join the swim team for conditioning and swim meets",
    ...
    "Drama Club": {
        "description": "Perform scenes, build stagecraft skills, and put on productions",
